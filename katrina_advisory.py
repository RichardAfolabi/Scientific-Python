...
text = str(text).lower().rstrip().lstrip()
...
alarm_terms = ["killed", "destroyed", "death", "devastating"]


alarmwords = 0

for terms in alarm_terms:
    print (terms, text.count(terms))
    alarmwords += text.count(terms)
...
print("Danger Level : " + str(alarmwords+3) if is_urgent == True else "low")
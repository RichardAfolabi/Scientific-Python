...
print("The number of paragraph is : %d "  % len(paragraphs))

print("The number of paragraph is : {} ".format(len(paragraphs)))
...
print("Numbers of lines of text : {} ".format(i))
...
print("there are {} empty lines".format(k))
